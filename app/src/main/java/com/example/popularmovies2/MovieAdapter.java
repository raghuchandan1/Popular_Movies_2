...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.MovieViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MovieViewHolder holder, int position) {
        ...
        Picasso.get() .load(IMAGE_BASE_URL +movies[position].getPoster_path()).placeholder(R.drawable.ic_movie_icon).resize(width/2,0).into(holder.moviePosterImageView);
    }
    ...
    public void getMoviesData(Movie[] movies){
        this.movies = movies;
    }
